...
export default function NewFullBlog ({ blog }: { blog: Blog }) {
  ...
  const [tempBlog, settempBlog] = useState({
    ...
    description:
      'Explore how AI is revolutionizing the way we build and interact with websites, and what this means for developers and users alike.',
...
Join me on this exciting journey as we explore the cutting-edge advancements in AI and their impact on the future of web development.`,
    ...
    comments: [
      ...
      },
      {
        ...
        author: 'Bob',
        content:
          "I'm excited to see how AI will shape the future of web development.",
        date: '2023-05-17'
      }
    ]
  })
      ...
      <div className='max-w-7xl mx-auto px-4 py-8 font-sans'>
        <div className='flex flex-col lg:flex-row gap-8'>
          ...
          <div className='lg:w-2/3'>
            ...
            <img
              src={blog.url}
              alt='conditional render the img'
              className=' w-full rounded-lg mb-6 h-80 object-fill'
            />
