    ...
    <div className="min-h-screen flex items-center justify-center bg-amber-50 p-4">
      <div className="bg-white rounded-md shadow-2xl w-full max-w-4xl flex flex-col md:flex-row overflow-hidden">
        <div className="w-full md:w-1/2 p-8 border-4 border-black bg-yellow-50">
          ...
          <p className="text-black text-lg mb-6 text-center">Join our vibrant community of bloggers and share your unique voice with the world!</p>
          <div className="flex justify-center space-x-4">
            <span className="bg-black rounded-full p-2">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-yellow-50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
