...
const Card = ({ children, className = '' }:Props) => (
  <div className={`bg-white drop-shadow-lg rounded-md ${className}`}>{children}</div>
)
...
export default function SingleBlog({id, authorName, title,content, publishDate}:BlogPost) {
