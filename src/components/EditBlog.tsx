...
import { ImagePlus, Send, X, HelpCircle, CheckCircle2, AlertCircle, Lightbulb, BookOpen } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-400 mb-4">Create Your Story</h1>
          <p className="text-lg text-gray-500">Share your thoughts and inspire others</p>
        </div>
              ...
              {activeTab === 'write' ? (
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        ...
                        {imagePreview ? (
                          ...
                          <>
                            ...
                            <div className="flex text-sm text-gray-600">
                              <label htmlFor="image-upload" className="relative cursor-pointer rounded-md font-medium text-purple-600 hover:text-purple-500 focus-within:outline-none">
                            ...
                            <p className="text-xs text-gray-500">High-quality PNG, JPG up to 10MB</p>
                          </>
                        )}
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="block w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl text-gray-900 text-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-150"
                ...
                <div className="p-6">
                  <div className="prose max-w-none">
                    ...
                    {imagePreview && (
                      <img src={imagePreview} alt="Cover" className="w-full h-64 object-cover rounded-xl mb-6" />
                    )}
                ...
                {showTips && (
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h3 className="font-medium text-gray-800">Engaging Title</h3>
                        <p className="text-sm text-gray-600">Keep it clear, specific, and intriguing</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Use headings and short paragraphs</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h3 className="font-medium text-gray-800">Visual Appeal</h3>
                        <p className="text-sm text-gray-600">Add relevant images to enhance your story</p>
                      </div>
                    </div>
                  </div>
                )}
